...
#Se pone pass para clase o método sin cuerpo
class SinCuerpo:
    pass
...
print(SinCuerpo)
print(type(SinCuerpo))
print(SinCuerpo.__class__)
print(SinCuerpo.__name__)
print(type(SinCuerpo).__name__)
print(SinCuerpo.__class__.__name__)